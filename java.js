...
form.addEventListener(
    "submit",function(e){
        ...
        let expenses=Number(document.getElementById("total_expenses").value)
        
        if( basic_salary&& benefits && expenses){
            ...
            let pat=Math.round(payee,2)
            document.getElementById("Final_payee").innerText=pat
            ...
            let nett=Math.round(net_pay)
            document.getElementById("Net_pay").innerText=nett
            
            let budget=calc_budget(net_pay,expenses)
            let bud2=Math.round(budget,2)
            document.getElementById("budget").innerHTML=bud2
...
// bid.addEventListener('submit',function(e){
//     e.preventDefault()
// let expenses=Number(document.getElementById("total_expenses").value)
...
// }
// else{
//     alert("please input your eexpenses")
// }
